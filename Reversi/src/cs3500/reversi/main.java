...
import cs3500.reversi.controller.HRController;
...
public class main {
  public static void main(String[] args) {
    ...
    ReversiView view = new ReversiTextualView(new ReadonlyHexReversiModel(model), out);
    HexReversiController controller = new HRController(model, view);
